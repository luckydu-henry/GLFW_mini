 ...
 *
 *  If you wish to on_update the refresh rate of the desired video mode in addition
 ...
 *  is specified.
 *
 *  If you only wish to on_update the resolution of a full screen window or the
